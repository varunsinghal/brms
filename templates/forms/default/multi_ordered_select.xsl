        ...
        <div class="container mt-2">
            <div class="form-group">
                ...
                <label for="{$identifier}">
                    <xsl:value-of select="multi-ordered-select/label"/> 
                </label>
                
                <div class="row align-items-center">
                    <div class="col-5">
                        <xsl:if test="multi-ordered-select/query">
                        ...
                        <xsl:if test="multi-ordered-select/options">
                            <select multiple="multiple" 
                                    class="form-control form-control-sm" 
                                    name="{$identifier}Left" id="{$identifier}Left">       
                                <xsl:for-each select="multi-ordered-select/options/option">
                    ...
                    <div class="col-1">
                        <i class="fas fa-angle-up" onClick="moveUp('{$identifier}')"></i>
                        <br/>
                        <i class="fas fa-angle-down" onClick="moveDown('{$identifier}')"></i>
                    </div>
                </div>
                
                <small class="form-text form-text-sm text-muted">
                    <xsl:value-of select="multi-ordered-select/tooltip"/>
                </small>
